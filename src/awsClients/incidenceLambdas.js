...
export function executeCreateTicketLambda(ticketDetailsData) {
...
export function executeFetchIncidenceLambda(userId, userRole) {
  return new Promise(function (resolve, reject) {
...
export function executeUploadFileS3(ticketId, fileName, fileId) {
  return new Promise(function (resolve, reject) {
...
export function getListingS3(complex) {
...
export function executeTicketActionLambda(request) {
  return new Promise(function (resolve, reject) {
    var lambda = new AWS.Lambda({
      region: "ap-south-1",
      apiVersion: "2015-03-31",
...
export function executeFetchReportLambda(userName, duration, complex) {
  return new Promise(function (resolve, reject) {
...
export function executeProgressLambda(ticketId) {
  return new Promise(function (resolve, reject) {
...
export function executeFetchTeamListLambda(ticketDetailsData) {
  return new Promise(function (resolve, reject) {
    var ticketDetails = { ticketDetailsData: ticketDetailsData }
    var lambda = new AWS.Lambda({
      region: "ap-south-1",
