                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        <div>
                                                            ...
                                                            >
                                                                {moment(new Date(parseInt(ticketData.timestamp))).fromNow()}
                                                            </p>
                                                        </div>
                                                    </div>
                                                </Link >
                    ...
                    <>
                        {displayData !== undefined && displayData.length !== 0 ?
                            displayData.map((ticketData, index) => {
                                if (modalShow === "") {
                                    return (
                                        ticketData.lead_id === ticketData.creator_id && ticketData.lead_id === props.name && ticketData.ticket_status !== "Closed" &&
                                        (
                                            <div
                                                className="animated fadeIn"
                                                style={{ ...whiteSurface, background: "white", marginTop: "20px" }}
                                    ...
                                    return (
                                        // ticketData.lead_id === props.name &&
                                        ticketData.lead_id === ticketData.creator_id && ticketData.lead_id === props.name &&
                                        (
                                            <div
                                                className="animated fadeIn"
                                                style={{ ...whiteSurface, background: "white", marginTop: "20px" }}
