                    ...
                    <>
                        {displayData !== undefined && displayData.length !== 0 ?
                            displayData.map((ticketData, index) => {
                                if (modalShow === "") {
                                    return (
                                        ticketData.lead_id !== ticketData.creator_id && ticketData.ticket_status !== "Closed" && ticketData.ticket_status !== "Queued" &&
                                        (
                                            <div
                                                className="animated fadeIn"
                                                style={{ ...whiteSurface, background: "white", marginTop: "20px" }}
                                    ...
                                    return (
                                        ticketData.lead_id !== ticketData.creator_id && ticketData.ticket_status !== "Queued" &&
                                        (
                                            <div
                                                className="animated fadeIn"
                                                style={{ ...whiteSurface, background: "white", marginTop: "20px" }}
