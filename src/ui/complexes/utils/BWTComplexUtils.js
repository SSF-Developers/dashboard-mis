...
export function getBWTCabinHealthData(rawData) {
    ...
    if (rawData.uiResult.alp === "true") {
        ...
        healthList.push(new NameValue("ALP", getStatusName(value), getStatusIcon(value)));
    }
    if (rawData.uiResult.mp1_valve === "true") {
        value = rawData.cabinHealth.data['MP1ValveHealth'];
        healthList.push(new NameValue("MP1 Valve", getStatusName(value), getStatusIcon(value)));
    }
    if (rawData.uiResult.mp2_valve === "true") {
        value = rawData.cabinHealth.data['MP2ValveHealth'];
        healthList.push(new NameValue("MP2 Valve", getStatusName(value), getStatusIcon(value)));
    }
    if (rawData.uiResult.mp3_valve === "true") {
        value = rawData.cabinHealth.data['MP3ValveHealth'];
        healthList.push(new NameValue("MP3 Valve", getStatusName(value), getStatusIcon(value)));
    }
    if (rawData.uiResult.mp4_valve === "true") {
        value = rawData.cabinHealth.data['MP4ValveHealth'];
        healthList.push(new NameValue("MP4 Valve", getStatusName(value), getStatusIcon(value)));
    }

    value = rawData.cabinHealth.data['BlowerHealth'];
    healthList.push(new NameValue("Blower", getStatusName(value), getStatusIcon(value)));
    value = rawData.cabinHealth.data['FailsafeHealth'];
    healthList.push(new NameValue("Fail Safe", getStatusName(value), getStatusIcon(value)));
    value = rawData.cabinHealth.data['FilterHealth'];
    healthList.push(new NameValue("Filter", getStatusName(value), getStatusIcon(value)));
    value = rawData.cabinHealth.data['OzonatorHealth'];
    healthList.push(new NameValue("Ozonator", getStatusName(value), getStatusIcon(value)));
    value = rawData.cabinHealth.data['PrimingValveHealth'];
    healthList.push(new NameValue("Priming Valve", getStatusName(value), getStatusIcon(value)));
    value = rawData.cabinHealth.data['PumpHealth'];
    healthList.push(new NameValue("Pump", getStatusName(value), getStatusIcon(value)));
...
export function getKeyCmsConfig(configNmae) {
    ...
    cmsConfigJeyLabelMap['Full Flush Activation Timer'] = 'fullflushactivationtimer'
    ...
    cmsConfigJeyLabelMap['Mini Flush Activation Timer'] = 'Miniflushactivationtimer'
...
export function getBwtPublishPayloadCommand(command, commandData, complex, cabin) {
    var payload = {}
