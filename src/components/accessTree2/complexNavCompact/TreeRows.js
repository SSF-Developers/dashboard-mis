...
import { setComplexData } from "../../../redux/actions/extra-actions";
...
export function ComplexRow(props) {
  ...
  return (
    ...
    >
      ...
      <div
        className="col-md-8"
        style={{ ...props.treeRowProps.displayDataStyle, display: "flex", alignItems: "center" }}>
        {props.treeRowProps.displayData}

      </div>
      <div className="col-md-2" style={{ display: "flex", justifyContent: "center", alignItems: "center", padding: "0" }}>
        <input type="checkbox" value={props.treeRowProps.displayData} onChange={handleChange}>
        </input>
      </div>
      {/* <div className="col-md-2" style={{ display: "flex", justifyContent: "center", alignItems: "center", padding: "0" }}>
        <Button
